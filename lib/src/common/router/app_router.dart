...
import 'package:contacts_app/src/common/router/modal_route_observer.dart';
...
abstract base class AppRouterBase {}

final class AppRouter = AppRouterBase
    with _AppRouterObservers, _AppRouterDelegate, _AppRouterShortcuts, _AppRouterGoRouter;

mixin _AppRouterObservers {
  final RouteObserver<ModalRoute<void>> _routeObserver = RouteObserver<ModalRoute<void>>();
  final NavigatorObserver _analyticsObserver = ModalRouteObserver();
}
